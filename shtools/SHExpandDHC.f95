subroutine SHExpandDHC(grid, py_m, py_n, lmax_calc, py_lmax, cilm, lmax, norm, sampling, csphase)
	...
	complex*16              ::	cc(2*py_m), gridl(2*py_m), fcoef1(2*py_m), fcoef2(2*py_m), ffc1(-1:1), ffc2(-1:1)
	integer                 ::	l, m, n, i, l1, m1, i_eq, i_s, astat(5), lmax_comp, nlong
	integer*8               ::	plan
	real*8                  ::	pi, aj(py_m), theta, prod, scalef, rescalem, u, p, pmm, pm1, pm2, z
